...
- 产品需求文档页面：[Final-HelpMeChoose_PRD.html](https://help-me-choose-tau.vercel.app/Final-HelpMeChoose_PRD.html)
- 产品需求文档源码：[Final-HelpMeChoose_PRD.html](./Final-HelpMeChoose_PRD.html)
...
├── index-v8.1.html
├── index-v8.2.html
├── Final-HelpMeChoose_PRD.html # 可通过 Vercel 渲染访问的 PRD 页面
├── PRD文件.html             # 同内容备份文件
└── help_me_choose_assets/   # PRD 页面所需的 mockup 与图表资源
```
...
- Rendered product requirement document: [Final-HelpMeChoose_PRD.html](https://help-me-choose-tau.vercel.app/Final-HelpMeChoose_PRD.html)
- Product requirement document source: [Final-HelpMeChoose_PRD.html](./Final-HelpMeChoose_PRD.html)
...
├── index-v8.1.html
├── index-v8.2.html
├── Final-HelpMeChoose_PRD.html # Rendered PRD page served through Vercel
├── PRD文件.html             # Same-content backup file
└── help_me_choose_assets/   # Mockup and diagram assets used by the PRD page
```
